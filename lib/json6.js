...
JSON6.debug = function(config) {
    if (typeof config.ll !== 'undefined') {
        _DEBUG_LL = config.ll;
    }
    if (typeof config.parsing !== 'undefined') {
        _DEBUG_PARSING = config.parsing;
    }
    if (typeof config.parsingStack !== 'undefined') {
        _DEBUG_PARSING_STACK = config.parsingStack;
    }
};
