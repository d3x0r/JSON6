 ...
 * @property {Json6Node} node
 * @property {NodeInfo|null|undefined} next
 * @property {NodeInfo|null} prior
 */

/**
 * @typedef {object} Context
 * @property {0|1|3|4} context
 * @property {Record<string, any>|null} elements
 * @property {any[]|null|undefined|number|string|boolean} element_array
...
JSON6.begin = function( cb, reviver ) {
	...
	const val = /** @type {{ name: string|null, value_type: number, string: string, contains: any }} */ ({ name : null,   // name of this value (if it's contained in an object)
	...
	/** @type {number} */ let word = WORD_POS_RESET,
		...
		/** @type {Record<string, any>|null|undefined} */ elements = undefined,
		/** @type {any[]|null} */ element_array = [],
	...
	const context_stack = /** @type {{
		...
		pop: () => Context
			...
			push(node) {
				...
				else { recover = /** @type {NodeInfo} */ ({ node : node, next : null, prior : this.last }); }
...
JSON6.stringifier = function() {
	...
	return {
		/**
		 * @param {any} o
		 * @param {((key: string, value: any) => any) | Array<string|number> | null} [r]
	...
	function getIdentifier(s) {
		/* istanbul ignore next -- object/array keys passed here are always strings, never numbers */
	...
	/**
	 * @param {ReturnType<typeof JSON6.stringifier>} stringifier
	 * @param {any} object
	 * @param {((key: string, value: any) => any) | Array<string|number> | null} [replacer]
